...
{
    $sql = "DELETE FROM supplier WHERE supplier_id = '$supplierId' OR supplier_name = '$supplierName'";
...
<div class="table table-border">
    ...
    <div class="table-div" data-id="update-inven-form">
        <div class="notif-form">
            <form action="./supplier_delete.php" method="GET" class="function-form php-form" data-id="upfate-main-form">
                <label>FILL IN ANY OF THE FOLLOWING:</label>
                <label>Supplier Id</label>
                <input type="number" name="supplier-id" required>

                <label>Supplier Name</label>
                <input type="text" name="supplier-desc">          
